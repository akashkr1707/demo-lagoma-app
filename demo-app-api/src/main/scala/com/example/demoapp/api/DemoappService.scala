...
object DemoappService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The demo-app service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the DemoappService.
  */
trait DemoappService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("demo-app")
      ...
      .withTopics(
        topic(DemoappService.TOPIC_NAME, greetingsTopic _)
